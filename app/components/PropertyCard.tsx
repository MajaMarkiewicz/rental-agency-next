    ...
    return (
        <div className="rounded-xl shadow-md relative">
            ...
            <div className="p-4">
                ...
                >
                    {rates.weekly && <p><FaMoneyBill className='md:hidden lg:inline'/> Weekly</p>}
                    {rates.monthly && <p><FaMoneyBill className='md:hidden lg:inline'/> Monthly</p>}
                    {rates.nightly && <p><FaMoneyBill className='md:hidden lg:inline'/> Nightly</p>}
                </div>
