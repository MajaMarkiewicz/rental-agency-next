...
const PropertyContactForm: React.FC<{property: PropertyApiGet}> = ({ property }) => {
  ...
  if (!session) {
    return (<h3 className="text-xl font-bold text-center pt-2">Login to enable contact form</h3>)
  }
