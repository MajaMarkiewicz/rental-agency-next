...
const searchResultsPage: React.FC<{ searchParams: SearchParams }> = async ({
  ...
  const propertiesFound = convertToSerializableObject(
    await Property.find(query).lean(),
  );
        ...
        <div className='container-xl lg:container m-auto px-4 py-6'>
          ...
          {propertiesFound.length === 0 ? (
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
              {propertiesFound.map((property: PropertyApiGet) => (
